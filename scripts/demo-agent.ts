import { CANONICAL_DEMO_PROMPT, PARSER_FUZZ_DEMO_PROMPT } from "../src/agent/prompts.js";
import { runAgentOperator } from "../src/agent/run.js";

const demoMode = process.argv.includes("--parser-fuzz") ? "parser-fuzz" : "static-source";
const prompt = demoMode === "parser-fuzz" ? PARSER_FUZZ_DEMO_PROMPT : CANONICAL_DEMO_PROMPT;

console.log("Contact Departure demo agent");
if (demoMode === "parser-fuzz") {
